...
def compute_all_game_name_distances(
    ...
    if use_levenshtein_distance:
        ...
        text_distances = compute_all_game_name_distances_with_levenshtein(
            input_game_name,
            steamspy_database,
        )
    else:
        ...
        text_distances = compute_all_game_name_distances_with_diff_lib(
            input_game_name,
            steamspy_database,
            n=n,
            junk_str=junk_str,
...
def find_most_similar_game_names(
    input_game_name,
    steamspy_database=None,
    use_levenshtein_distance=True,
    n=3,
    ...
    text_distances = compute_all_game_name_distances(
        input_game_name,
    ...
    sorted_app_ids = sorted(
        text_distances.keys(),
        key=lambda app_id: text_distances[app_id],
    )
